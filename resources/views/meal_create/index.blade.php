...
<x-app-layout>
    <div class="mt-1 xl:mt-2 mb-5">
        ...
        <form method="POST" action="{{ route('meal_create.create') }}" id="meal_create_form" class="m-0 mt-2">
            @csrf
            <x-element.input type="date" label="ひづけ" id="meal_date" :db="null" />
            <x-element.input type="time" label="じかん" id="meal_time" :db="null" />
            <x-element.input type="text" label="めも" id="memo" :db="null" />
